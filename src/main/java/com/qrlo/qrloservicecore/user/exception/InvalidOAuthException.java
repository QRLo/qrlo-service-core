package com.qrlo.qrloservicecore.user.exception;
...
public class InvalidOAuthException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected InvalidOAuthException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
